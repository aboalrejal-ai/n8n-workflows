...
def generate_static_search_index(db_path: str, output_dir: str) -> Dict[str, Any]:
    ...
    for workflow in workflows:
        ...
        search_workflow = {
            ...
            "download_url": f"https://raw.githubusercontent.com/aboalrejal-ai/n8n-workflows/main/workflows/{extract_folder_from_filename(workflow['filename'])}/{workflow['filename']}",
        }
